...
Có nhiều nguồn cung cấp dữ liệu cho bài toán dự đoán giá đồng tiền mã hóa, nghiên cứu này có sử dụng các lịch sử giao dịch các đổng với nhau (trading pair) được lấy từ  API có sẵn từ 8 sàn giao dịch với cấu trúc bảng như sau:\\ % \csvautotabular[respect 
%\resizebox{\textwidth}{!}{%
